...
mkdir -p "${PACKAGER_TOPDIR}/libexec"
...
# groff
cp -a "${PREFIX_PORTABLE_DIR}/share/doc" "${PACKAGER_TOPDIR}/share/"
cp -a "${PREFIX_PORTABLE_DIR}/share/groff" "${PACKAGER_TOPDIR}/share/"
cp -a "${PREFIX_PORTABLE_DIR}/share/info" "${PACKAGER_TOPDIR}/share/"
cp -a "${PREFIX_PORTABLE_DIR}/lib/groff" "${PACKAGER_TOPDIR}/lib/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/addftinfo" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/afmtodit" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/chem" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/eqn" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/eqn2graph" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/gdiffmk" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/glilypond" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/gperl" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/gpinyin" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grap2graph" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grn" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grodvi" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/groff" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grog" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grolbp" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grolj4" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/gropdf" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grops" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/grotty" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/hpftodit" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/indxbib" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/lkbib" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/lookbib" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/mmroff" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/neqn" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/nroff" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/pdfmom" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/pdfroff" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/pfbtops" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/pic" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/pic2graph" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/post-grohtml" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/preconv" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/pre-grohtml" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/refer" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/soelim" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/tbl" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/tfmtodit" "${PACKAGER_TOPDIR}/bin/"
cp -a "${PREFIX_PORTABLE_DIR}/bin/troff" "${PACKAGER_TOPDIR}/bin/"
# gdbm
...
PKG_VERSION=692
PKG_SOURCE="${PKG_NAME}-${PKG_VERSION}.tar.gz"
PKG_SOURCE_URL="https://www.greenwoodsoftware.com/less/${PKG_SOURCE}"
PKG_SOURCE_SUBDIR="${PKG_NAME}-${PKG_VERSION}"
...
PKG_VERSION=1.26
PKG_SOURCE="${PKG_NAME}-${PKG_VERSION}.tar.gz"
PKG_SOURCE_URL="https://ftp.gnu.org/gnu/gdbm/${PKG_SOURCE}"
PKG_SOURCE_SUBDIR="${PKG_NAME}-${PKG_VERSION}"
PKG_HASH="6a24504a14de4a744103dcb936be976df6fbe88ccff26065e54c1c47946f4a5e"
...
PKG_VERSION=1.5.8
PKG_SOURCE="${PKG_NAME}-${PKG_VERSION}.tar.gz"
PKG_SOURCE_URL="https://download-mirror.savannah.gnu.org/releases/libpipeline/${PKG_SOURCE}"
PKG_SOURCE_SUBDIR="${PKG_NAME}-${PKG_VERSION}"
PKG_HASH="1b1203ca152ccd63983c3f2112f7fe6fa5afd453218ede5153d1b31e11bb8405"
...
PKG_SOURCE_URL="https://mirror.accum.se/mirror/gnu.org/savannah/man-db/${PKG_SOURCE}"
PKG_SOURCE_SUBDIR="${PKG_NAME}-${PKG_VERSION}"
